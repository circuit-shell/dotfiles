...
set -g @nova-segment-mode "#[fg=#282a36]#{?client_prefix,💀 ,👻 }"
set -g @nova-segment-mode-colors "#89c0d0 default"
set -g @nova-segment-whoami "#[fg=#282a36]󰖟  #(ipconfig getifaddr $(route -n get default | grep interface | cut -d: -f2 | tr -d ' '))"
