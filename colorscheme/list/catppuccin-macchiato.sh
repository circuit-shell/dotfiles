...
# Filename: ~/github.com/circuit-shell/dotfiles/colorscheme/list/catppuccin-macchiato.sh
# ~/github.com/circuit-shell/dotfiles/colorscheme/list/catppuccin-macchiato.sh
